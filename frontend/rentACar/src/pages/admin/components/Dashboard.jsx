          ...
          <Link to="slider" style={{ textDecoration: "none" }}>
            <Card>
              ...
              <Button style={{
                ...
                background: "linear-gradient(90deg, rgba(104,11,156,1) 0%, rgba(56,0,83,1) 100%)", color: "white"
              }} size="md">{t("slider")}</Button>
            </Card>
          </Link>
        </Grid>
